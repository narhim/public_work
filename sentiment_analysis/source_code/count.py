class count:
	...
	def list_abs_freq(self,list_words):
		'''Function that, given a list of words, returns a dictionary in which the keys are every type of word and the values are the frequency of each word in the input list.'''
		dic_frequencies = {}
