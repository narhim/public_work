...
def main():
	...
	pos_counts_binary = counting.list_abs_freq(pos_text_binary) #TEST
	neg_counts_binary = counting.list_abs_freq(neg_text_binary) #TEST
	
	#Get the vocabulary (commented lines are other ways to obtain the vocabulary)
	...
	sum_pos_binary = sum(pos_counts_binary.values())#TEST
	sum_neg_binary = sum(neg_counts_binary.values())#TEST
	...
	print("Scores for positive reviews:")
	evaluation.calculate_scores(results_pos,results_neg)
	print("Scores for negative reviews:")
