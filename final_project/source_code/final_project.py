...
def main():
	...
	pos_text_training, pos_num_files = path.list_raw_text_n_files('train/pos')
	neg_text_training, neg_num_files = path.list_raw_text_n_files('train/neg')
...
#
	...
	pos_text_test, pos_num_files_test = path.list_raw_text_n_files('test/pos')
	neg_text_test, neg_num_files_test = path.list_raw_text_n_files('test/neg')
